# Bug Fix
1. Play button should be fixed in the middle. This problem is caused by the mod button changing length and it is alligning to the left edge, maybe align it's pos base on it's right edge would help
...
5. Library update
    ...
    3. implement a find current song feature in library 
6. Add Playlist page
